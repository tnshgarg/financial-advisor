...
function WordpressPost({
  ...
  return (
    <div className="bg-[#fff] rounded-xl shadow-md w-[33%] md:w-[100%]">
      <div className="py-5 pb-4 mb-2 flex flex-row align-middle items-center justify-between bg-[#00A0D2] px-7 rounded-tl-xl rounded-tr-xl">
      ...
      <div className="px-7">
        <Button
          ...
          className="w-full rounded-3xl animate-pulse bg-[#00A0D2] hover:bg-[#00A0D2] text-white text-md mb-5 font-bold"
        >
