  ...
  const plans = [
    {
      ...
      features: [
        ...
        "Generate Youtube CPs",
        "Generate Youtube Short Scripts",
        "Generate IG Reels Script",
    ...
    },
    {
      ...
      features: ["Everything in Basic Plan", "400 Generations Per Month"],
      actionLabel: "Get Started",
      popular: true,
    },
    {
      ...
      features: ["Custom Generation Options"],
      actionLabel: "Contact support@draaft.ai",
      exclusive: true,
    },
  ];
  return (
